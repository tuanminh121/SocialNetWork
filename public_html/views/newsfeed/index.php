...
<main class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8" id="main-news-feed " style="margin-left: 10%">
            <!--THINKING POST-->
            <div class="card mb-4 thinking-post">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <button style="color:   #c20a13;" class="btn btn-link btn-lg"><i class="fas fa-video"></i> Video trực tiếp</button>
                        <button style="color:   #c20a13;" class="btn btn-link btn-lg"><i class="fas fa-images"></i> Ảnh/Video</button>
                        <button style="color:   #c20a13;" class="btn btn-link btn-lg"><i class="far fa-grin-wink"></i> Cảm xúc</button>
                    </div>
                </div>
            </div>
            <!--News-->
                        ...
                        <li class="comment-item myDIV">
                            ...
                            <div id="edit-comment" class="hide">
                                <div class="option-comment option-icon collapsible">
                                    <span id="btn-edit" class="material-icons-outlined option-comment option-icon"
                                        style="font-size:15px">
                                        edit
                                    </span>
                                </div>
                                <form class="content" id="form-edit-comment"
                                    action="index.php?controller=newsfeed&action=editComment" method="post">
                                    <input class="ID" type="text" value="<?php echo $row_comment['UserID']; ?>"
                                        name="CommentUserID">
                                    <input class="ID" type="text" value="<?php echo $UserID; ?>" name="UserID">
                                    <!--Người đăng nhập-->
                                    <input class="ID" type="text" value="<?php echo $row_comment['CommentID']; ?>"
                                        name="CommentID">
                                ...
                                <a href="index.php?controller=newsfeed&action=deleteComment&CommentID=<?php echo $row_comment['CommentID']; ?>"
                                    class="link-dark">
                                    <!--Người đăng nhập-->
        ...
        <div id="right-side-bar">
            ...
            ?>
            <a class="row"
                href="index.php?controller=profile&action=getFriendInfo&UserIDFriend=<?php echo $row_friend['UserID']; ?>">
                <div class="sidebar-item">
                    <div class="icon">
                        <img src="<?php echo ($row_friend['UserAva']); ?>" alt=""
