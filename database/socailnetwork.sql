...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 07, 2022 lúc 02:08 PM
...
--
-- Cấu trúc bảng cho bảng `friend_ship`
--
...
--
-- Đang đổ dữ liệu cho bảng `friend_ship`
--
...
--
-- Cấu trúc đóng vai cho view `view_comment`
...
--
-- Cấu trúc đóng vai cho view `view_post`
-- (See below for the actual view)
--
...
--
-- Cấu trúc cho view `view_comment`
--
...
--
ALTER TABLE `comment`
  MODIFY `CommentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
-- Các ràng buộc cho bảng `friend_ship`
--
ALTER TABLE `friend_ship`
