                ...
                <div class="col-md-5 mb-4 mb-md-0">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <a href="index.php?controller=profile&action=viewImage&UserID=<?php echo $frdInfo['UserID'] ?>"
                                class="btn btn-link d-inline-block py-1 px-3" style="float: right">Xem tất cả ảnh</a>
                            <?php
           $count = 0;
           if ($profileImg)
           ...
           ?>
                            <div class="col-lg-4 mb-3">
                                <a href="<?php echo $row_img['images'] ?>" target="_blank">
                                    <img src="<?php echo $row_img['images'] ?>" alt=""
                                        onclick="clickImg('<?php echo $row_img['images'] ?>')"
                                        class="w-100 shadow-1-strong rounded" style="height: 100px;" />
                                </a>
                            </div>
                            <?php
                  ...
                  if ($profileFriend)
                    ...
                    ?>
                            ...
                            <div class='card_right d-inline-block' style='float: right'>
                                <a href='index.php?controller=profile&action=viewFriend&UserID=<?php echo $frdInfo['UserID'] ?>'
                                    class='btn btn-link py-1 px-3'>Xem tất cả bạn bè</a>
                            </div>
                            <?php
                    if ($profileFriend)
                    foreach ($profileFriend as $rowFriends) {
